...
return [
    ...
    'admin' => [
        ...
        'stats' => [
            ...
            'views_chart' => 'Total des vues',
            'likes_chart' => 'Total des j\'aime',
    ...
    'settings' => [
        ...
        'discord' => [
            ...
            'enabled' => 'Activer les notifications Discord',
            'enabled_help' => 'Envoyer une notification Discord lors de la publication d\'une annonce.',
            'webhook_url' => 'URL du Webhook',
            'webhook_url_help' => 'Obtenez-le depuis les paramètres de votre serveur Discord.',
            'webhook_required' => 'Veuillez entrer une URL de webhook.',
            'test_webhook' => 'Tester le webhook',
            'testing' => 'Test en cours...',
            'test_success' => 'Webhook testé avec succès ! Vérifiez votre serveur Discord.',
            'test_failed' => 'Le test du webhook a échoué',
            'username' => 'Nom d\'utilisateur du bot',
            'username_help' => 'Nom affiché pour le bot (optionnel).',
            'avatar_url' => 'URL de l\'avatar',
            'content' => 'Message personnalisé',
            'content_help' => 'Message affiché au-dessus de l\'embed (optionnel).',
            'available_variables' => 'Variables disponibles (cliquez pour insérer) :',
            'preview' => 'Prévisualisation',
            'embed_settings' => 'Configuration de l\'embed',
            'embed_title' => 'Titre de l\'embed',
            'embed_description' => 'Description de l\'embed',
            'embed_color' => 'Couleur de l\'embed',
            'embed_footer' => 'Texte du footer',
            'embed_footer_icon' => 'Icône du footer (URL)',
            'embed_thumbnail' => 'Miniature (URL)',
            'embed_timestamp' => 'Afficher la date',
            'embed_image' => 'Afficher l\'image de couverture',
            'embed_author' => 'Afficher l\'auteur',
            'embed_field_category' => 'Afficher la catégorie',
        ],
